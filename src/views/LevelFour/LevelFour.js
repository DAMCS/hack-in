...
import RoomFour from 'assets/images/level4/levelfour.jpg'
	...
	render() {
		let customState = EmulatorState.create({
			'fs': FileSystem.create({
				...
				'/var/www/html/README': {content: 'Try something different to be on top.'},
			}),
				...
				<React.Fragment>
					<div class="d-flex justify-content-center align-items-center">
						...
						<map name="image-door">
							...
							<area id='painting' alt="monalisa" title="painting" coords="592,229,722,301" shape="rect" onClick={this.toggleWindow} />
